...
with st.sidebar:
    st.markdown("""
        <div style="text-align: center; margin-bottom: 20px;">
            <i class="fas fa-water" style="font-size: 40px; color: #1e3a8a;"></i>
...
if not file:
    ...
    try:
        # --- DATA PROCESSING (Logika asli dipertahankan) ---
        ...
        with tab_grafik:
            ...
            # Data Observasi (Warna abu-abu yang elegan)
            ...
            # Data Prediksi (Gradient biru laut)
            fig.add_trace(go.Scatter(
                x=waktu_prediksi, y=model_pred, 
                name='Prediksi Model (utide)', 
                mode='lines',
                line=dict(color='#2563eb', width=2),
                fill='tozeroy',           # Efek air (area chart)
